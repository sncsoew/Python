...
def task_8():
    ...
    gar={'Все виды цветов':garden_set.union(meadow_set),'Растут и на лугу и в саду':garden_set.intersection(meadow_set),'Растут только в саду':garden_set.difference(meadow_set),'Растут только на лугу':meadow_set.difference(garden_set)}
    return (gar)